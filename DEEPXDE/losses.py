...
def mean_squared_error_list(y_true, y_pred):
...
def mean_squared_error(y_true, y_pred):
    ...
    print('损失内部',bkd.square(y_true - y_pred))
    print('损失内部',bkd.reduce_mean(bkd.square(y_true - y_pred)))
